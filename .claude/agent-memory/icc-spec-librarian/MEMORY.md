...
- [Corpus defects are caught from outside](feedback_corpus_defects_are_caught_from_outside.md) — **read this first of the five lesson memories**; n=5 and not one was found by re-reading; arrange for a second consumer
...
- [lcms2 measured quirks live in one file](reference_lcms2_measured_behaviour_file.md) — `M<n>` ids at pin 21c582a; check M2 (forced BPC), M4 (4-input CLUT is a hybrid, not tetrahedral) and M5 (v2-display wtpt→D50, 11 ΔE) before blaming any transform
